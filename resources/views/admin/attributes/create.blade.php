                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="input-group">
                            ...
                            <input type="text" placeholder="Sabor" name="description" class="form-control" value="{{ old('description') }}">
                            <input type="hidden" placeholder="Sabor" name="value" class="form-control" value="Sabor">
                        </div>
                    </div>
